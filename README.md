...
[![Latest Version](https://img.shields.io/github/release/RTcustom/laravel-analytics.svg?style=flat-square)](https://github.com/RTcustom/laravel-analytics/releases)
[![Software License](https://img.shields.io/badge/license-MIT-brightgreen.svg?style=flat-square)](LICENSE.md)
[![Build Status](https://img.shields.io/travis/RTcustom/laravel-analytics/master.svg?style=flat-square)](https://travis-ci.org/RTcustom/laravel-analytics)
[![Quality Score](https://img.shields.io/scrutinizer/g/RTcustom/laravel-analytics.svg?style=flat-square)](https://scrutinizer-ci.com/g/RTcustom/laravel-analytics)
[![Total Downloads](https://img.shields.io/packagist/dt/RTcustom/laravel-analytics.svg?style=flat-square)](https://packagist.org/packages/RTcustom/laravel-analytics)

This is an opinionated Laravel 5 package to retrieve Google Analytics data.

RTcustom is a webdesign agency in Antwerp, Belgium. You'll find an overview of all our open source projects [on our website](https://RTcustom.be/opensource).
