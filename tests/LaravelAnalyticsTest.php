...
class LaravelAnalyticsTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->client = Mockery::mock('\RTcustom\LaravelAnalytics\GoogleApiHelper');
        $this->siteId = '12345';

        $this->laravelAnalytics = new \RTcustom\LaravelAnalytics\LaravelAnalytics($this->client, $this->siteId);
    }
    ...
    {
        $enabledAnalytics = new \RTcustom\LaravelAnalytics\LaravelAnalytics($this->client, $this->siteId);
        $this->assertTrue($enabledAnalytics->isEnabled());

        $disabledAnalytics = new \RTcustom\LaravelAnalytics\LaravelAnalytics($this->client);
